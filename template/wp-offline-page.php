	...
	<body class="betaplugin">
		...
		<div id="bcSOFF_container"<?php echo $background_image; ?>>
			<div class="bcSOFF_message_box_wrapper">
				...
				<p class="bcSOFF_label">Powered by <a href="https://wordpress.org" target="_blank" rel="nofollow">Wordpress</a> and <a href="https://www.fkprojeto.com/" target="_blank" rel="nofollow">Site Offline by FK</a>.</p>
				<?php } ?>
